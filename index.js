...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] TINGGAL FOLLOW IG @serenyemnyem Dan Scan Qr`);
});
...
_${kata}_
   ...
   {
    axios.get(https://mhankbarbar.herokuapp.com/api/random/hentai?apiKey=lGjYt4zA5SQlTDx9z9Ca`)
      .then((result) => {
        var b = JSON.parse(JSON.stringify(result.data));
